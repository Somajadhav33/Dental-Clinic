  ...
  <tr>
    <td style="background:#f9f9f9;padding:20px;text-align:center;border-top:1px solid #dddddd;">
      ...
      <p style="color:#666666;font-size:13px;margin:0;">
        Email: info@aabhadentalclinic.com
      </p>
    </td>
  </tr>
`;
  ...
  <tr>
    <td style="padding:30px;">
      ...
      <p style="color:#333333;font-size:15px;line-height:1.6;margin:0 0 30px;">
        Your appointment at Aabha Dental Clinic has been confirmed.
      </p>
        ...
        <tr>
          <td style="padding:15px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              ...
              ${infoRow("Clinic:", `AABHA DENTAL CLINIC, ${clinic}`)}
      ...
      <p style="color:#666666;font-size:14px;line-height:1.6;margin:0;text-align:center;">
        For any changes, please contact us at +91 22 4123 4567
      </p>
    </td>
  </tr>
...
export const APPOINTMENT_CONFIRMED_EMAIL = ({
  ...
  <tr>
    <td style="padding:30px;">
      ...
      <p style="color:#666666;font-size:14px;line-height:1.6;margin:0;text-align:center;">
        We look forward to seeing you. Contact us at +91 22 4123 4567 for any questions.
      </p>
    </td>
  </tr>
...
export const REPORT_READY_EMAIL = ({ patientName, appointmentId, reportUrl }) =>
  ...
  <tr>
    <td style="padding:30px;">
      ...
      <p style="color:#666666;font-size:14px;line-height:1.6;margin:0;text-align:center;">
        For questions about your report, call us at +91 22 4123 4567
      </p>
    </td>
  </tr>
...
export const APPOINTMENT_RESCHEDULED_EMAIL = ({
  ...
  <tr>
    <td style="padding:30px;">
      ...
      <p style="color:#666666;font-size:14px;line-height:1.6;margin:0;text-align:center;">
        Contact us at +91 22 4123 4567 if you need to make further changes.
      </p>
    </td>
  </tr>
...
export const APPOINTMENT_CANCELLED_EMAIL = ({
  ...
  <tr>
    <td style="padding:30px;">
      ...
      <table width="100%" cellpadding="20" cellspacing="0" style="background:#f5f5f5;border:1px solid #dddddd;margin-bottom:20px;text-align:center;">
        <tr>
          <td>
            ...
            <a href="https://aabhadentalclinic.com/book-appointment" style="display:inline-block;background:#2c5282;color:#ffffff;text-decoration:none;padding:12px 30px;font-size:15px;">
              Book Now
            </a>
          </td>
        </tr>
      ...
      <p style="color:#666666;font-size:14px;line-height:1.6;margin:0;text-align:center;">
        Questions? Contact us at +91 22 4123 4567
      </p>
    </td>
  </tr>
...
export const CONTACT_AUTOREPLY_EMAIL = ({ name }) =>
  ...
  <tr>
    <td style="padding:30px;">
      ...
      <p style="color:#333333;font-size:15px;line-height:1.6;margin:0 0 30px;">
        Thank you for contacting Aabha Dental Clinic. We have received your message and will respond within 24-48 hours.
      </p>
      ...
      <table width="100%" cellpadding="15" cellspacing="0" style="background:#fffbea;border:1px solid #f0e68c;margin-bottom:20px;">
        <tr>
          <td>
            <p style="color:#666666;font-size:14px;line-height:1.6;margin:0;">
              <strong>For Urgent Matters:</strong> Please call us directly at +91 22 4123 4567
            </p>
          </td>
        </tr>
      </table>
...
export const APPOINTMENT_REMINDER_EMAIL = ({
  ...
  <tr>
    <td style="padding:30px;">
      ...
      <p style="color:#666666;font-size:14px;line-height:1.6;margin:0;text-align:center;">
        Need to reschedule? Call us at +91 22 4123 4567
      </p>
    </td>
  </tr>
